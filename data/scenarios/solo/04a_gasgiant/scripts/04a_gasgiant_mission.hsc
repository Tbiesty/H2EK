		...
		(begin
			...
			(if (objects_can_see_object (players) rec_cen_rein_01l 45)
				(begin
					...
					(if (< (ai_living_count rec_center_heretics) 9)
						(ai_place rec_cen_rein_grt_01L 1)
					)
...
;	(ai_place rec_center_grunts_05)
	...
	(if (< (ai_living_count rec_center_heretics) 9)
		(ai_place rec_center_grunts_04 2)
	)
...
(script dormant underhangar_reinforce
	...
	(if 
		(AND
			...
			(begin
				(if (< (ai_living_count underhangar_heretics) 9)
